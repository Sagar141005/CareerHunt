...
export const jobPostBodyValidator = [
  ...
  body("type")
    ...
    .withMessage("Enter a valid job type"),
  body("level")
    .notEmpty()
    .withMessage("Level is required")
    .isIn(["Intern", "Junior", "Mid", "Senior", "Lead"])
    .withMessage("Enter a valid job level"),
  body("department")
    .notEmpty()
    ...
    .withMessage("Enter a valid department"),
  body("deadline")
    .notEmpty()
...
export const updateStatusValidator = [
  ...
  body("status")
    ...
    .isIn(["Shortlisted", "Interview", "Offer", "On-hold", "Rejected", "Hired"])
